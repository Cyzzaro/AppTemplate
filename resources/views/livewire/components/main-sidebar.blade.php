...
<div class="w-64 bg-gray-800 text-white flex flex-col h-screen">
    ...
    <nav class="flex-1 mt-6">
        <a href="#"
            class="flex items-center px-4 py-2 text-gray-300 hover:bg-gray-700 hover:text-white transition duration-150 ease-in-out">
    ...
    <div class="p-4 border-t border-gray-700">
        <a href="{{ route('logout') }}"
            ...
            class="w-full flex items-center px-4 py-2 text-gray-300 rounded-lg hover:bg-red-700 hover:text-white transition duration-150 ease-in-out">
            <svg class="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round"
